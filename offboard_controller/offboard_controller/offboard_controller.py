...
class OffboardController(Node):
    def __init__(self):
        ...
        # Subscriptions
        self.target_xyz_sub = self.create_subscription(PoseStamped, '/goal', self.autonomous_phase_one, 10)
        ...
        self.orangepose_sub = self.create_subscription(PoseStamped, '/mavros/vision_pose/pose', self.update_orangepose_cb, 10)
