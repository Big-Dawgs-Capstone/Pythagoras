...
class FisheyeCameraPublisher(Node):
    """
    Publishes a stream of Images from MMLove's 720P02 Fisheye Camera.
    """
    ...
    def __init__(self):
        ...
        # CVBridge allows for conversion between cv::Mat to ros2 Image type
        ...
        # check whether device number valid
        if dev_num < 0:
